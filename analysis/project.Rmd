...
# Alcohol popularity by time

alc_time <- left_join(countries, spirit_data, by = c("admin" = "Country"))

  # b_time  <- ggplot() +
  # geom_sf(data = countries, fill = NA) +
  # geom_sf(data = alc_time %>% 
  # filter(!is.na(Year)), mapping = aes(fill = Beverage_Types)) +
  # labs(title = "Change in popularity of alcohol",
  ...
  # 
  # animate(b_time, duration = 30, fps = 20)
```
